 ...
 *  Copyright 2024 Dr.Smyrke <admin@drsmyrke.ru>
 *
...
ColumnLayout {
	...
	property bool cfg_CategoryPhotos
	property bool cfg_CategoryMy
	...
	Kirigami.FormLayout {
		...
		GroupBox {
			...
			RowLayout {
				...
				CheckBox {
					text: i18n("My")
					checked: cfg_CategoryMy
					onToggled: {
						cfg_CategoryMy = checked;
					}
				}
				CheckBox {
					text: i18n("Photos")
					checked: cfg_CategoryPhotos
					onToggled: {
						cfg_CategoryPhotos = checked;
					}
				}
			}
		}
